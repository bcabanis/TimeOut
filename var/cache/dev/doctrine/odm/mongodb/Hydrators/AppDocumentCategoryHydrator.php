 ...
 */
class AppDocumentCategoryHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate(object $document, array $data, array $hints = array()): array
    {
        ...
        if (isset($data['subCategories']) || (! empty($this->class->fieldMappings['subCategories']['nullable']) && array_key_exists('subCategories', $data))) {
            $value = $data['subCategories'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['subCategories']['type'];
                $return = $value;
            } else {
                $return = null;
            }
            $this->class->reflFields['subCategories']->setValue($document, $return);
            $hydratedData['subCategories'] = $return;
        }
        return $hydratedData;
    }
}