...
class Generated53bd741c02c73edadd5bea6900043921 extends \App\Document\Category implements \ProxyManager\Proxy\GhostObjectInterface
{
    ...
    private function callInitializer9dad3($methodName, array $parameters)
    {
        ...
        static $cacheApp_Document_Category;

        $cacheApp_Document_Category ?? $cacheApp_Document_Category = \Closure::bind(static function ($instance) {
            $instance->name = '';
            $instance->subCategories = [];
        }, null, 'App\\Document\\Category');

        $cacheApp_Document_Category($this);
        ...
        static $cacheFetchApp_Document_Category;

        $cacheFetchApp_Document_Category ?? $cacheFetchApp_Document_Category = \Closure::bind(function ($instance, array & $properties) {
            $properties['' . "\0" . 'App\\Document\\Category' . "\0" . 'name'] = & $instance->name;
            $properties['' . "\0" . 'App\\Document\\Category' . "\0" . 'subCategories'] = & $instance->subCategories;
        }, null, 'App\\Document\\Category');

        $cacheFetchApp_Document_Category($this, $properties);
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\App\Document\Category $instance) {
            unset($instance->name, $instance->subCategories);
        }, $instance, 'App\\Document\\Category')->__invoke($instance);
