...
namespace MongoDBODMProxies\__PM__\App\Document\Calendar;

class Generated8da95630a5ea3155782be3583d5623d5 extends \App\Document\Calendar implements \ProxyManager\Proxy\GhostObjectInterface
{
    /**
    ...
    private static $signature8da95630a5ea3155782be3583d5623d5 = '';
    ...
    private function callInitializer9dad3($methodName, array $parameters)
    {
        ...
        static $cacheApp_Document_Calendar;

        $cacheApp_Document_Calendar ?? $cacheApp_Document_Calendar = \Closure::bind(static function ($instance) {
            $instance->name = '';
            $instance->subCategories = [];
        }, null, 'App\\Document\\Calendar');

        $cacheApp_Document_Calendar($this);
        ...
        static $cacheFetchApp_Document_Calendar;

        $cacheFetchApp_Document_Calendar ?? $cacheFetchApp_Document_Calendar = \Closure::bind(function ($instance, array & $properties) {
            $properties['' . "\0" . 'App\\Document\\Calendar' . "\0" . 'name'] = & $instance->name;
            $properties['' . "\0" . 'App\\Document\\Calendar' . "\0" . 'subCategories'] = & $instance->subCategories;
        }, null, 'App\\Document\\Calendar');

        $cacheFetchApp_Document_Calendar($this, $properties);
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\App\Document\Calendar $instance) {
            unset($instance->name, $instance->subCategories);
        }, $instance, 'App\\Document\\Calendar')->__invoke($instance);
