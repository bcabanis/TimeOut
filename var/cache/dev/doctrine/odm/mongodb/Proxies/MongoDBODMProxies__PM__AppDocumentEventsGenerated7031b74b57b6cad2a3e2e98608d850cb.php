...
class Generated7031b74b57b6cad2a3e2e98608d850cb extends \App\Document\Events implements \ProxyManager\Proxy\GhostObjectInterface
{
    /**
    ...
    private static $protectedPropertiesd2cba = [
        'category' => 'App\\Document\\Events',
        'title' => 'App\\Document\\Events',
        'description' => 'App\\Document\\Events',
        'eventDate' => 'App\\Document\\Events',
        'address' => 'App\\Document\\Events',
        'imageUrl' => 'App\\Document\\Events',
        'eventId' => 'App\\Document\\Events',
    ];

    private static $signature7031b74b57b6cad2a3e2e98608d850cb = '';
    ...
    private function callInitializer9dad3($methodName, array $parameters)
    {
        ...
        $properties = [
            ...
            '' . "\0" . '*' . "\0" . 'eventDate' => & $this->eventDate,
            '' . "\0" . '*' . "\0" . 'address' => & $this->address,
            '' . "\0" . '*' . "\0" . 'imageUrl' => & $this->imageUrl,
            '' . "\0" . '*' . "\0" . 'eventId' => & $this->eventId,
        ];
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        unset($instance->category, $instance->title, $instance->description, $instance->eventDate, $instance->address, $instance->imageUrl, $instance->eventId);
