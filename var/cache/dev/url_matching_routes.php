...
return [
    ...
    [ // $staticRoutes
        ...
        '/home/homepresentation' => [[['_route' => 'app_home_presentation', '_controller' => 'App\\Controller\\HomeController::presentation'], null, null, null, false, false, null]],
        ...
        '/login/loginavatar' => [[['_route' => 'app_login_avatar', '_controller' => 'App\\Controller\\LoginController::avatar'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        85 => [
            [['_route' => 'app_event_post_chat_message', '_controller' => 'App\\Controller\\EventController::postChatMessage'], ['eventId'], ['POST' => 0], null, false, false, null],
